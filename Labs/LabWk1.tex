...
That out of the way, here's how you can get started:
...
To compile a basic C program:


\item Open a terminal (\texttt{ctrl + alt + t}). It will start to your ``home directory'' (ie: any commands typed will effect files in your home directory). 
...
then type out the code seen in Figure \ref{fig:gedit}.
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\textwidth]{c_ubuntu.png}
\end{center}
