...
\\~\\
For use in the next task there are \texttt{csv} files which contain a gap-free subset of this data: \texttt{rainfall-1.csv} and \texttt{rainfall-12.csv}.
\end{task}
...
\\~\\
From data in the \texttt{rainfall} array calculate the mean, lowest, and highest rainfall figures for each month and compare them with BOM's calculations. Use one (or more) \texttt{for} loops to perform this analysis.
\\~\\
