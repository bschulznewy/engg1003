...
Building on the code in the previous task, copy the code below into a script and run it. Observe that the result of the $y = 2*x$ expression is also an array. All 11 values in \texttt{x} have been multiplied by 2 and the results packed into the \texttt{y} variable.
...
With those fundamental principles explored, now is a good time to complete reading and executing textbook Section 1.5.
...
\begin{task}{Plotting Mathematical Functions}{}
