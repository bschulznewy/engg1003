...
\pagebreak
\section{Pseudocode - C conversion examples}
...
\item \textbf{Variable:} A ``thing'' which remembers a number within your program. In C they have a \textit{type}, a name, and (optionally) an initial value.
