...
Run though these questions quickly and ask your demonstrator if any appear confusing. These all cover basic fundamentals required to complete the lab.

\begin{enumerate}
\item Write a \texttt{printf();} statement which takes an integer variable \texttt{counter} and prints \texttt{The value of counter is 123} to the screen (with 123 replaced with the actual value).
