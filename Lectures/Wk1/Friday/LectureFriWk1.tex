...
\setlength{\itemsep}{1pt}
  ...
  \setlength{\parsep}{0pt}
	...
	\item Observe that as $k$ increases in Equation \ref{eq:cosseries} the denomenator increases \textit{really fast} (4!=24, 10!=3628800)
...
\item We loops until 10 \textit{iterations} have occured OR a precision limit is reached
\end{itemize}
\end{columns}
\end{frame}
