...
~\\
``If the change between $x_n$ and $x_{n+1}$ is greater than some precision value OR the number of iterations is less than maximum then continue iterating''
\end{itemize}
\end{frame}
