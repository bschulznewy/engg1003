...
\begin{frame}[fragile]
\frametitle{Scripts Vs. Python Console}
\begin{itemize}
\item The Python Console:
	\begin{itemize}
		...
		\item Great for:
			\begin{itemize}
				...
				\item Learning
				\item Experimenting
				\item \textit{Debugging} small segments
			\end{itemize}
	\end{itemize}
\item Script files:
	\begin{itemize}
		\item Allow creation of longer programs
		\item Are much easier to edit
		\item Should be used for anything more than 2-3 lines long
	\end{itemize}
\end{itemize}
\end{frame}
...
\frametitle{Scripts Vs. Python Console}
\begin{itemize}
\item In labs you (may) have been running a \textit{script} or used Python through the \textit{Python Console}

\item Live example, download \texttt{ball.py} from: \url{https://raw.githubusercontent.com/slgit/prog4comp_2/master/py36-src/ball.py}
...
% HERE BE DRAGONS
% sqrt algorithm notes; probably too advanced for week 1
